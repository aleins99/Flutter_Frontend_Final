  ...
  void _selectDate(BuildContext context) async {
    final DateTime? picked = await showDatePicker(
      ...
      initialDate: _selectedDate ??
          DateTime
              .now(), // Usa la fecha seleccionada previamente o la fecha actual si _selectedDate es null
      firstDate: DateTime(2000), // Fecha inicial del date picker
      lastDate: DateTime(2025), // Fecha final del date picker
    );
    if (picked != null && picked != _selectedDate) {
      setState(() {
        _selectedDate = picked;
        _controllerFecha.text = _selectedDate!
            .toIso8601String(); // Actualiza el controlador de la fecha con la nueva fecha seleccionada
      });
    }
  }
